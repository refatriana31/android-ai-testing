---
id: 121-pro-m-005
title: Invalid photo type or failed upload is handled gracefully
priority: medium
timeout_seconds: 90
uat_id: PRO-M-005
...
- Precondition (from UAT): Profile photo upload is available
...
6. Attempt unsupported or broken upload

## Expected
- UAT expected: System rejects invalid upload with a clear message
...
## Notes
- Auto-generated from UAT catalog row PRO-M-005. Refine wording as needed.
