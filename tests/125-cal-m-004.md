---
id: 125-cal-m-004
title: Events and assignments use clear color or visual distinction
priority: medium
timeout_seconds: 90
uat_id: CAL-M-004
...
- Precondition (from UAT): Calendar contains both item types
...
6. Open calendar with mixed items

## Expected
- UAT expected: Different item types are distinguishable
...
## Notes
- Auto-generated from UAT catalog row CAL-M-004. Refine wording as needed.
