---
id: 127-cal-m-006
title: Tapping a calendar item opens the correct detail
priority: medium
timeout_seconds: 90
uat_id: CAL-M-006
...
- Precondition (from UAT): Calendar contains at least one item
...
6. Tap an event and then an assignment from calendar

## Expected
- UAT expected: Correct detail page opens for each item
...
## Notes
- Auto-generated from UAT catalog row CAL-M-006. Refine wording as needed.
