---
id: 131-sec-m-005
title: Reopening the app after logout does not restore protected session accidentally
priority: medium
timeout_seconds: 120
uat_id: SEC-M-005
...
- Precondition (from UAT): Learner has just logged out
...
6. Close and reopen app or mobile browser

## Expected
- UAT expected: User remains logged out
...
## Notes
- Auto-generated from UAT catalog row SEC-M-005. Refine wording as needed.
