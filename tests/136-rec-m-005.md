---
id: 136-rec-m-005
title: No-interest state shows a safe fallback rather than broken recommendations
priority: low
timeout_seconds: 90
uat_id: REC-M-005
...
- Precondition (from UAT): Learner clears or has no interests selected
...
6. Open homepage or recommendation area

## Expected
- UAT expected: System shows fallback recommendations or a clear empty state
...
## Notes
- Auto-generated from UAT catalog row REC-M-005. Refine wording as needed.
