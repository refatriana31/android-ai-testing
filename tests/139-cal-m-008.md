---
id: 139-cal-m-008
title: Calendar empty state is clear when learner has no upcoming items
priority: low
timeout_seconds: 90
uat_id: CAL-M-008
...
- Precondition (from UAT): Learner has no dated items
...
## Expected
- UAT expected: Calendar shows clean empty state
...
## Notes
- Auto-generated from UAT catalog row CAL-M-008. Refine wording as needed.
