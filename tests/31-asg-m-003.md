---
id: 31-asg-m-003
title: Assignment status updates from Given to In Progress to Done based on learner activity
priority: high
timeout_seconds: 150
uat_id: ASG-M-003
...
- Precondition (from UAT): Assignment is accessible and learner can make progress
...
## Expected
- UAT expected: Status reflects current learner progress
...
## Notes
- Auto-generated from UAT catalog row ASG-M-003. Refine wording as needed.
