---
id: 42-auth-m-004
title: First-time login with default password prompts password change
priority: high
timeout_seconds: 90
uat_id: AUTH-M-004
...
- Precondition (from UAT): New learner account exists with default password
...
6. Login using default password

## Expected
- UAT expected: System allows access only through the required first-time password change flow
...
## Notes
- Auto-generated from UAT catalog row AUTH-M-004. Refine wording as needed.
