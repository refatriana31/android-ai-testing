---
id: 49-team-m-001
title: Manager can open Team Activity View from the mobile app
priority: high
timeout_seconds: 90
uat_id: TEAM-M-001
...
- Precondition (from UAT): User has manager role and at least one team member
...
6. Open mobile app
7. Navigate to Team Activity View

## Expected
- UAT expected: Team Activity View opens successfully on mobile
...
## Notes
- Auto-generated from UAT catalog row TEAM-M-001. Refine wording as needed.
