---
id: 59-auth-m-003
title: Learner logs in using SSO on mobile when SSO is enabled
priority: medium
timeout_seconds: 90
uat_id: AUTH-M-003
...
- Precondition (from UAT): SSO is enabled for tenant
...
6. Tap SSO login
7. Complete IdP authentication

## Expected
- UAT expected: User returns authenticated to the mobile experience
...
## Notes
- Auto-generated from UAT catalog row AUTH-M-003. Refine wording as needed.
