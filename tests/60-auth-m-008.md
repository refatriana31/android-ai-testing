---
id: 60-auth-m-008
title: Wrong current password blocks password change
priority: medium
timeout_seconds: 90
uat_id: AUTH-M-008
...
6. Attempt password change using wrong current password

## Expected
- UAT expected: Password change is rejected with a clear validation message
...
## Notes
- Auto-generated from UAT catalog row AUTH-M-008. Refine wording as needed.
