---
id: 75-lib-m-010
title: Quiz multiple choice embedded in course is accessible on mobile
priority: medium
timeout_seconds: 90
uat_id: LIB-M-010
...
- Precondition (from UAT): Library item includes quiz/test
...
6. Open content item with quiz or test

## Expected
- UAT expected: Learner can start the quiz/test from mobile
...
## Notes
- Auto-generated from UAT catalog row LIB-M-010. Refine wording as needed.
