---
id: 76-lib-m-011
title: Quiz question and answer options that contain images render clearly on mobile
priority: medium
timeout_seconds: 90
uat_id: LIB-M-011
...
- Precondition (from UAT): A quiz contains image-based question or image-based answer options
...
6. Start the quiz and review one or more image-based questions

## Expected
- UAT expected: Images render clearly, remain tappable, and do not overlap text or answer controls
...
## Notes
- Auto-generated from UAT catalog row LIB-M-011. Refine wording as needed.
