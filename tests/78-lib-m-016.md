---
id: 78-lib-m-016
title: Learner can review quiz result details with correct and incorrect indicators after submission when enabled
priority: medium
timeout_seconds: 90
uat_id: LIB-M-016
...
- Precondition (from UAT): Quiz result review is enabled for the learner
...
6. Submit a quiz; open result detail or review page

## Expected
- UAT expected: Result page clearly shows score and which answers were correct or incorrect without broken layout
...
## Notes
- Auto-generated from UAT catalog row LIB-M-016. Refine wording as needed.
