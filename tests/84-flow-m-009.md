---
id: 84-flow-m-009
title: Timer per test works correctly on mobile when enabled
priority: medium
timeout_seconds: 120
uat_id: FLOW-M-009
...
- Precondition (from UAT): Timed test is configured at test level
...
6. Start timed test and monitor countdown

## Expected
- UAT expected: Timer behaves correctly and submission behavior at timeout follows rules
...
## Notes
- Auto-generated from UAT catalog row FLOW-M-009. Refine wording as needed.
