---
id: 92-evt-m-004
title: Online event detail shows join method clearly on mobile
priority: medium
timeout_seconds: 90
uat_id: EVT-M-004
section: 4.7 Events
...
- Precondition (from UAT): Online event exists
...
6. Open online event detail

## Expected
- UAT expected: Join link or access method is clear and usable
...
## Notes
- Auto-generated from UAT catalog row EVT-M-004. Refine wording as needed.
