---
id: 95-evt-m-007
title: Survey attached to event is accessible on mobile
priority: medium
timeout_seconds: 90
uat_id: EVT-M-007
section: 4.7 Events
...
- Precondition (from UAT): Event has survey
...
6. Complete or attend the event stage that triggers survey

## Expected
- UAT expected: Survey opens correctly
...
## Notes
- Auto-generated from UAT catalog row EVT-M-007. Refine wording as needed.
