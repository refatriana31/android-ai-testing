---
id: 97-evt-m-009
title: Full or unavailable event blocks extra registration on mobile
priority: medium
timeout_seconds: 90
uat_id: EVT-M-009
section: 4.7 Events
...
- Precondition (from UAT): Event is full or closed
...
6. Open event detail and attempt register

## Expected
- UAT expected: Registration is blocked with clear state
...
## Notes
- Auto-generated from UAT catalog row EVT-M-009. Refine wording as needed.
